...
def start_label_detection(bucket, key):
    ...
    # print('SNSTopicArn is ' + os.environ['REKOGNITION_SNS_TOPIC_ARN'])
    # print("RoleArn={}".format(os.environ['REKOGNITION_ROLE_ARN']))
...
def put_labels_in_db(data, video_name, videos_bucket):
    pass
